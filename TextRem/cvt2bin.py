...
if __name__ == '__main__':
    ...
    model_weights_path = "pretrain.pth"
    images = os.listdir('poc_images')
    for image in images:
        input_image_path = os.path.join('poc_images', image)
...
# python demo/demo.py --config-file configs/DPText_DETR/TotalText/R_50_poly.yaml --input poc_images/1.jpg --output output/1.png --opts MODEL.WEIGHTS pretrain.pth
